...
interface IERC20{
    ...
    //function transferencia_loteria(address cliente, address recipient, uint256 amount) external returns (bool);
...
contract ERC20Basic is IERC20{
   ...
   function balanceOf (address tokenOwner) public override view returns (uint256){
    ...
    // function transferencia_loteria(address _emisor, address receiver, uint256 numTokens) public override returns (bool){
    //     // Se comprueba que el cliente tiene saldo suficiente para realizar la transaccion
